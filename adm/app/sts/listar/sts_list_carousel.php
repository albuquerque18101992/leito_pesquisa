            ...
            <div class="list-group-item">
                <div class="d-flex">
                    ...
                    <div class="p-2">
                        ...
                        if ($btn_cad) {
                            echo "<a href='" . pg . "/cadastrar/sts_cad_carousel' class='btn btn-success btn-sm'>Cadastrar</a>";
                        }
                        ?>
                    </div>
                </div>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border border-dark">Ordem</th>
                                    <th class="d-none d-sm-table-cell border border-dark">Imagem</th>
                                    <th class="d-none d-sm-table-cell border border-dark">Situação</th>
                                    <th class="text-center border border-dark">Ações</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                while ($row_carousel = mysqli_fetch_assoc($resultado_carousel)) {
                                    ?>
                                    <tr>
                                        <th class="border border-dark"><?php echo $row_carousel['id']; ?></th>
                                        <td class="border border-dark"><?php echo $row_carousel['nome']; ?></td>
                                        <td class="border border-dark"><?php echo $row_carousel['ordem']; ?></td>
                                        <td class="d-none d-sm-table-cell border border-dark">
                                        ...
                                        <td class="text-center border border-dark">
                                            <span class="d-none d-md-block">
                                                ...
                                                if ($btn_vis) {
                                                    echo "<a href='" . pg . "/visualizar/sts_vis_carousel?id=" . $row_carousel['id'] . "' class='btn btn-primary btn-sm'>Visualizar</a> ";
                                                }
                                                $btn_edit = carregar_btn('editar/sts_edit_carousel', $conn);
                                                if ($btn_edit) {
                                                    echo "<a href='" . pg . "/editar/sts_edit_carousel?id=" . $row_carousel['id'] . "' class='btn btn-warning btn-sm'>Editar </a> ";
                                                }
                                                $btn_apagar = carregar_btn('processa/sts_apagar_carousel', $conn);
                                                if ($btn_apagar) {
                                                    echo "<a href='" . pg . "/processa/sts_apagar_carousel?id=" . $row_carousel['id'] . "' class='btn btn-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a> ";
                                                }
