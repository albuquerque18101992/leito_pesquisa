                        ...
                        <div class="d-flex">
                            ...
                            <div class="p-2">
                                <span class="d-none d-md-block">
                                    ...
                                    if ($btn_apagar) {
                                        echo "<a href='" . pg . "/processa/apagar/apagar_usuario?id=" . $row_user_vis['id'] . "' class='btn btn-outline-danger btn-sm' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a> ";
                                    }
                                    ?>
                                </span>
                                <div class="dropdown d-block d-md-none">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="acoesListar">
                                        ...
                                        if ($btn_apagar) {
                                            echo "<a class='dropdown-item' href='" . pg . "/processa/apagar/apagar_usuario?id=" . $row_user_vis['id'] . "' data-confirm='Tem certeza de que deseja excluir o item selecionado?'>Apagar</a>";
                                        }
                                        ?>
                                    </div>
                                </div>
