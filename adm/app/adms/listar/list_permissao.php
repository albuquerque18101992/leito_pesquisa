                                    ...
                                    while ($row_niv_ac = mysqli_fetch_assoc($resultado_niv_ac)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                if ($btn_ordem_menu) {
                                                    if ($qnt_linhas_exe == 1) {
                                                        echo "<button class='btn btn-secondary btn-sm disabled'><i class='fas fa-angle-double-up'></i></button> ";
                                                    } else {
                                                        echo "<a href='" . pg . "/processa/proc_ordem_menu?id=" . $row_niv_ac['id'] . "' class='btn btn-secondary btn-sm'><i class='fas fa-angle-double-up'></i></a> ";
                                                    }
                                                }
                                                $qnt_linhas_exe++;
                                                ?></td>
